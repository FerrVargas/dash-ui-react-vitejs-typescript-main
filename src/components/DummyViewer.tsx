  ...
  useEffect(() => {
    ...
    SceneLoader.Append(
      ...
      () => {
        ...
        // Verificar mallas asociadas al esqueleto
        scene.meshes.forEach((mesh: Mesh) => {
          if (mesh.skeleton) {
            console.log(`🧩 Malla skineada: ${mesh.name}`);
          }
        });

        // Buscar hueso de la mano derecha
